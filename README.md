...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vcywjcm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vcywjcm.containers.anotherwebservice.com/
...
```
git clone git@github.com:MikeProk/container-vcywjcm.git
cd container-vcywjcm
```
...
```
docker attach container-vcywjcm
```
